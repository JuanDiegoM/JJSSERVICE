...
<html>
    <head>
        ...
        <jsp:include page="index.jsp"></jsp:include>
            ...
            <br><br>
            <form action="" method="post" id="formularioTipoVehiculo" name="formularioTipoVehiculo">
                <div class = "row">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger" onclick="borrarTipoVehiculo(<%=rs.getString(1)%>);" id="btnEliminarTipoVehiculo" name="btnEliminarTipoVehiculo">
