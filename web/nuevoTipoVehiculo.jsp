                ...
                <div class = "col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form action="" method="post" id="formNuevoTipoVehiculo" name="formNuevoTipoVehiculo">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group">                                    
                                        <div class="col-md-5">
                                            <br>
                                            <input type="button" class="btn btn-success" value="Guardar" id="guardarNuevoTipoVehiculo">
